<script>
    ...
    let schedules = [];
    async function load() {
        schedules = await get("/schedules/" + $loggedUserCF + "/" + $role);
    }
    async function elimina(id) {
        console.log("id", id);
        let res = await del("/schedule/" + id);
        detail = undefined;
        load();
    }
    function back() {
            ...
            <table class="table-auto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {detail.idambulatorio?.idambulatorio ??
                                "idambulatorio"}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            {detail.idambulatorio?.indirizzo ?? " "}
                            {detail.idambulatorio?.idstanza ?? " "}
                        </td>
                    </tr>
                    <tr>
